import os
os.makedirs('/app/frontend/components', exist_ok=True)
txt = '''\'use client\'
    ...
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-3.5 left-4 z-50 w-10 h-10 flex items-center justify-center
                   rounded-xl bg-indigo-900 border border-indigo-700 shadow-lg shadow-indigo-950/60
      ...
      `}>
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${active
                    ? \'bg-indigo-800/80 text-white shadow-sm shadow-indigo-900\'
              ...
              >
                <span className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0
                  transition-colors
                  ${active ? \'bg-indigo-700\' : \'bg-indigo-900/60 group-hover:bg-indigo-800\'}`}>
        ...
        {/* Footer */}
        <div className="px-5 py-4 border-t border-indigo-800/50">
